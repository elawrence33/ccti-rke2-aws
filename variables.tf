...
variable "vpc_id" {
  ...
  type        = string
  default     = "vpc-0f5a1a61fdab1721c" // Original: No default
}

variable "subnets" {
  description = "List of subnet IDs to create resources in"
  type        = list(string)
  default     = ["subnet-0743b94bb6e65bbb8", "subnet-0e61d75e396c7f476"] // Original: No default
}
...
variable "instance_type" {
  type        = string
  default     = "t2.2xlarge" // Original t3.medium
...
variable "ami" {
  ...
  type        = string
  default     = "ami-01f87c43e618bf8f0" // Use for Ubuntu 20.04: ami-84556de5 // Original: no default
}
...
variable "spot" {
  ...
  type        = bool
  default     = true // Original value: false
}
