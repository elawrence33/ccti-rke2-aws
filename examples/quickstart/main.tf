...
locals {
  ...
  aws_region   = "us-west-1" // Original value: us-gov-west-1
...
# data "aws_ami" "rhel8" {  // Original: rhel8
#   most_recent = true  // Original: true
#   owners      = ["335603356943"] # This is the account ID # Original value: 219670896067

#   filter {
#     name   = "name"
#     values = ["RHEL-8*"]  // Original: RHEL-8*
#   }
...
module "rke2" {
  ...
  ami                   = var.ubuntuAmi // Original: data.aws_ami.rhel8.image_id
